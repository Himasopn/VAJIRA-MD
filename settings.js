...
global.owner = process.env.OWNER_NUMBER  || '79098911933' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=PRNlkL6Y#eWyj1KycfS9DK3gjywqwqtBUqRx8csp1Lb7GzgGUVmo' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "79098911933" : process.env.MODERATORS ,    
